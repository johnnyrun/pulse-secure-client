...
docker ps -a |grep pulse-client || docker create --privileged --name pulse-client --device /dev/net/tun --cap-add net_admin --cap-add sys_admin --volume /tmp/.X11-unix:/tmp/.X11-unix --env DISPLAY  -v ~/.pulse:/data  $IMAGE
